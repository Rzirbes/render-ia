...
export function RenderHistoryLoading() {
  return (
    <div className="flex h-65 flex-col items-center justify-center gap-3 text-sm text-text-muted">
...
export function RenderHistoryError({ message }: { message: string }) {
  return (
    <div className="flex h-65 flex-col items-center justify-center gap-3 text-sm text-red-400">
...
export function RenderHistoryEmpty() {
  return (
    <div className="flex h-65 flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-surface/30 px-6 text-center">
